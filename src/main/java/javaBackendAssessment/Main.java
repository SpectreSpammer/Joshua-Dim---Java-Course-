...
import javaBackendAssessment.service.EmployeeServiceImpl;
...
public class Main {
    public static void main(String[] args) {
        ...
        String filePath = "C:\\Users\\MUGIWARA\\Downloads\\One Piece of Java Tutorial\\Students\\Employees.xlsx";
        ...
        try {
            ...
            try {
                Employee emp = ems.getEmployee(1);
            ...
            try {
                ...
                list.add(new Manager(0, "", "", "", 0, 0, null, 0)); // This will throw NullPointerException
